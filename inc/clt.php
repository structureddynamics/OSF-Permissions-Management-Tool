<?php
  ...
  function getInput($msg, $bool = FALSE)
  {
    ...
    if($bool)
    {
      if(strtolower($varin) == 'y')
      {
        $varin = 'yes';
      }
      
      if(strtolower($varin) == 'n')
      {
        $varin = 'no';
      }
      
      return(filter_var($varin, FILTER_VALIDATE_BOOLEAN, array('flags' => FILTER_NULL_ON_FAILURE)));
    }
